...
echo "Running ProcessTMAverageData.py. See log output at $LOGDIR"
...
if [ $? -ne 0 ]; then
    echo "An error occurred while running ProcessTMAverageData.py. See log outputs at $LOGDIR for more information. Exiting..."
    exit 1
fi
